...
import { UniswapFlashSwap } from '../typechain/UniswapFlashSwap'
...
async function main() {
  ...
  let uniswapFlashSwap : UniswapFlashSwap 




  const FlashSwap = await ethers.getContractFactory("UniswapFlashSwap");
  uniswapFlashSwap=await FlashSwap.attach("0xAb5186829296fd0cDC7A860dDEB2c8F562dDF505") as UniswapFlashSwap
